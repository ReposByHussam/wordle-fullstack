...
function GamePage() {
  ...
  async function handleSaveScore(name) {
    try {
      ...
      //Kontrollerar att det sparas och saveHighsore sätts rätt
      console.log("result från saveHighscore:", result);
      ...
      <div className="game-card">
        ...
        <section className="panel">
          ...
          {settings && (
            <div className="settings-summary">
              <p>
                <strong>Ordlängd:</strong> {settings.wordLength}
              </p>
              <p>
        ...
        {scoreSaved && savedHighscore && (
          <section className="panel success-panel">
            ...
            <p>
              <strong>Namn:</strong> {savedHighscore.name}
            </p>
            <p>
              <strong>Antal gissningar:</strong> {savedHighscore.guessCount}
            </p>
            <p>
              <strong>Tid (ms):</strong> {savedHighscore.durationMs}
            </p>
